...
static void print_usage()
{
    ...
    fprintf(stderr, "  -f pattern-format    output image filename pattern format (%%08d.jpg/png, default=ext/%%08d.png)\n");
}
